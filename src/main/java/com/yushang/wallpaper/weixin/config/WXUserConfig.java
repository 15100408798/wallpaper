...
public class WXUserConfig {
    ...
    public static String getCode() {
        ...
        str.append("appid=" + WXConfig.appid).append("&");
        str.append("redirect_uri=" + WXConfig.redirectUri).append("&");
        str.append("response_type=code").append("&");
        str.append("scope=snsapi_userinfo").append("&");
    ...
    public static String getAccessToken(String code) {
        ...
        str.append("appid=" + WXConfig.appid).append("&");
        str.append("secret=" + WXConfig.secret).append("&");
        str.append("code=" + code).append("&");
