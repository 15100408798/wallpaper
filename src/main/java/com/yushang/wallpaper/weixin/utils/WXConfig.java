...
public final class WXConfig {
    ...
    /**    =================================微信授权============================   */
    public final static String codeUrl = "https://open.weixin.qq.com/connect/oauth2/authorize?";//授权地址

    public final static String appid = "wx77af26778620bf3a";//微信公众号appid

    public final static String secret = "e24dbce60640c408afa0a165e0131acf";//微信公众号密码

    public final static String redirectUri = "http://www.aaarj.com/bicycle/weixin/user/getAccessToken";//跳转地址
