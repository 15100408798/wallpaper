(function(){
	...
	$.fn.openWindow = function(setTitle,setContents,setButton){
		...
		var _html ='<div class="window-masking" style="height: 300px;font-size: 50px"></div>'+
		'<div class="window-container fix" id="addNew">'+
			'<h2></h2>'+
			'<div class="window-content">'+
				'<p class="window-text" style="font-size: 50px"></p>'+
			'</div>'+
			'<div class="window-btn fix">'+
				'<a class="cancel-button fl" href="javascript:;" style="font-size: 30px"></a>'+
				'<a class="confirm-button fr" href="javascript:;" style="font-size: 30px"></a>'+
